            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Ususrios</a></li>
                ...
                <div class="card-body">
                    ...
                    <form id="form-create" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="email" name="email" placeholder="Correo electrónico del usuario" required>
                        </div>
                        <div class="mb-3">
...
@section('script')
@vite([
'resources/js/users/create.users.js',
])
@endsection