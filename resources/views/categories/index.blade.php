    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Listado de Categorias</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-end">
                <a href="{{route("categories.create")}}" class="btn btn-success rounded-pill"><i class="ri-add-fill"></i> Nuevo</a>
            </div>
...
@section('script')
@vite([
'resources/js/categories/index.categories.js',
])
@endsection